...
export default function NotFound() {
    return (<div className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-background pt-20 pb-12 px-6">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-2xl mx-auto text-center">
        ...
        <motion.div className="relative w-40 h-40 sm:w-56 sm:h-56 -mt-10 mb-8 flex items-center justify-center" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}>
          {/* Animated Rings */}
          <motion.div className="absolute inset-0 rounded-full border border-destructive/20" animate={{ scale: [1, 1.5, 2], opacity: [1, 0.5, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "linear" }}/>
          <motion.div className="absolute inset-0 rounded-full border border-destructive/10" animate={{ scale: [1, 1.5, 2], opacity: [1, 0.5, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "linear", delay: 1.5 }}/>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button variant="secondary" size="lg" href="/services" icon={<ArrowLeft className="w-5 h-5"/>}>
              Our Services
            </Button>
          </div>
        </motion.div>
