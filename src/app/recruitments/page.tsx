...
import { 
  ShieldCheck, Search, GraduationCap, ClipboardCheck, 
  ShieldAlert, CheckCircle2, Fingerprint, LockKeyhole,
  ArrowRight, Heart, HardHat, Wrench, Sparkles, Scale, 
  Leaf, Siren, LayoutList, CheckSquare, Target, BookOpen
} from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative flex justify-center lg:justify-end">
              ...
              >
                ...
                <motion.div 
                  className="absolute inset-8 rounded-full border border-brand/60"
                  animate={{ rotate: -360 }}
                ...
                <motion.div 
                  className="absolute -top-4 -right-4 bg-slate-900 border border-white/10 px-4 py-2 rounded-xl shadow-xl flex items-center gap-2"
                  animate={{ y: [0, -10, 0] }}
                ...
                <motion.div 
                  className="absolute bottom-12 -left-8 bg-slate-900 border border-white/10 px-4 py-2 rounded-xl shadow-xl flex items-center gap-2"
                  animate={{ y: [0, 10, 0] }}
      ...
      <section className="py-24 bg-background relative border-y border-border">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* Card 1 */}
            <div className="relative p-8 rounded-3xl border border-border bg-surface hover:bg-surface-elevated transition-all duration-300 group overflow-hidden">
              ...
              activeTab === tab.id && (
                ...
                >
                  {tab.modules.map((module, i) => (
                    <div key={i} className="flex items-start gap-3 p-5 rounded-2xl glass border border-border hover:border-brand/30 hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="py-32 bg-surface-elevated relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-6 lg:px-8 relative z-10">
          ...
          <div className="relative border-l-2 border-border/50 ml-6 md:ml-1/2 md:border-l-0">
            ...
            <motion.div 
              className="hidden md:block absolute left-1/2 top-0 w-[2px] bg-gradient-to-b from-brand via-brand-light to-brand -translate-x-1/2"
              initial={{ height: "0%" }}
            ...
            {STAGES.map((stage, index) => (
              <motion.div 
                key={stage.title}
                className={`relative flex items-center justify-between md:justify-normal w-full mb-20 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}
      ...
      <section id="audits" className="py-24 bg-background relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {AUDITS.map((audit, i) => (
              <div key={i} className="flex items-center gap-3 p-4 rounded-xl border border-border bg-surface hover:bg-brand/5 hover:border-brand/30 transition-all duration-300 group cursor-default">
