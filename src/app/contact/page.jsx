...
export default function ContactPage() {
    return (<main className="pt-32 pb-24 sm:pb-32 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <SectionHeading badge="Get In Touch" title="Contact Our" titleHighlight="Expert Team" description="Have questions about our facility management services or looking for a customized proposal? Reach out to us today."/>
          ...
          <motion.div 
            ...
            <div className="p-8 rounded-3xl border border-border bg-surface-glass">
              ...
              <div className="flex flex-wrap gap-2">
                {["Telangana", "Andhra Pradesh", "Karnataka", "Tamil Nadu", "Odisha"].map((state) => (<span key={state} className="px-3 py-1.5 rounded-full text-xs font-semibold bg-brand/10 text-brand-light border border-brand/20">
                    {state}
                  </span>))}
              </div>
            </div>
        ...
        <motion.div 
          ...
          className="mt-24 mb-10 relative">
          <SectionHeading badge="Location" title="Find Us on" titleHighlight="The Map" align="center" className="mb-12"/>
          ...
          <div className="relative w-full h-[500px] rounded-[2rem] overflow-hidden border border-border shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] group">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4530.047296199675!2d78.3725816751661!3d17.439157883456883!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb93e7400a98af%3A0xb86a441596737d73!2sAMAZE%20Property%20Management%20Solutions%20Pvt.%20Ltd!5e1!3m2!1sen!2sbd!4v1785329289157!5m2!1sen!2sbd" width="100%" height="100%" style={{ border: 0 }} allowFullScreen={true} loading="lazy" referrerPolicy="strict-origin-when-cross-origin" className="absolute inset-0 w-full h-full filter grayscale-[0.2] contrast-[1.05] opacity-90 transition-all duration-500 group-hover:grayscale-0 group-hover:opacity-100"/>
          </div>
        </motion.div>
      </div>
    </main>);
