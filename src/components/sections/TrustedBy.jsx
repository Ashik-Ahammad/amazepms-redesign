...
export function TrustedBy() {
    return (<section id="clients" className="relative py-16 border-y border-border bg-surface">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <motion.p className="text-center text-xs font-semibold tracking-widest uppercase text-muted-foreground mb-10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
        ...
        <div className="relative overflow-hidden">
          ...
          <motion.div className="flex items-center gap-16" animate={{ x: ["0%", "-50%"] }} transition={{
            x: {
                duration: 25,
                repeat: Infinity,
                ease: "linear",
            ...
            {[...TRUSTED_CLIENTS, ...TRUSTED_CLIENTS].map((client, i) => (<div key={`${client}-${i}`} className="flex-shrink-0 flex items-center justify-center h-12 px-8">
